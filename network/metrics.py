...
class MaterialRenderMetrics(Loss):
    ...
    def __call__(self, data_pr, data_gt, step, *args, **kwargs):
        ...
        #                    'diffuse_color']
        additional_keys = ['sources', 'tangents', 'bitangents', 
                           'normals', 'kd', 'ks', 'specular_light', 'diffuse_light', 
                           'F0' , 'specular_color', 'diffuse_color', 'mx', 'my',
                           'alpha', 'f_d_sum', 'f_s_sum', 'L_spec']
