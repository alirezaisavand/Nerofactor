    ...
    def train_step(self, step):
        ...
        if self.cfg['reg_mat']:
            ...
            shade_outputs['loss_mat_reg'] = self.shader_network.anisotropic_regularization(
                pts, normals,  shade_outputs['sources'], shade_outputs['tangents'], shade_outputs['bitangents'], shade_outputs['mx'], shade_outputs['my'], shade_outputs['alpha'], shade_outputs['F0'],
