...
from utils.base_utils import color_map_forward, color_map_backward, downsample_gaussian_blur
...
class NeROShapeRenderer(nn.Module):
    ...
    def _init_dataset(self):
        ...
        self.train_ids, self.test_ids, self.nvs_ids = get_database_split(self.database)
...
class NeROMaterialRenderer(nn.Module):
    ...
    def test_step(self, index, is_nvs=False):
        ...
        output_keys = {'ray_rgb':3, 'gradient_error':3, 'normal':3, 'depth':3,
    ...
    def nvs(self, log_dir_str, imgs_dir):
        ...
        with log_path.open("a", encoding="utf-8") as f:
            for index in range(len(self.nvs_ids)):
                ...
                imgs = [rgb_gt, rgb_pr]
                imsave(os.path.join(imgs_dir, "test_{}.png".format(self.nvs_ids[index])),
