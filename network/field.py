...
class MCShadingNetwork(nn.Module):
    ...
    def sample_aniso_ggx_directions(self,
        ...
        h = (coeff_x.unsueeze(2) * x.unsqueeze(1).expand(coeff_x.shape[0], coeff_x.shape[1], 3) +
             coeff_y.unsueeze(2) * y.unsqueeze(1).expand(coeff_x.shape[0], coeff_x.shape[1], 3) +
             coeff_z.unsueeze(2) * z.unsqueeze(1).expand(coeff_x.shape[0], coeff_x.shape[1], 3))
